...
- **Ephemeral container executors, phase 1 (Docker only)** — implements the design in `docs/superpowers/specs/2026-07-13-ephemeral-container-executors-design.md`, now marked "Implemented (phase 1)". Two new packages:
